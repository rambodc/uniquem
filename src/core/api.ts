...
export type Inquiry = { id: string; inquiryType: string; productName?: string; name: string; email: string; company?: string; phone?: string; message: string; createdAt: string | null; archived: boolean };
